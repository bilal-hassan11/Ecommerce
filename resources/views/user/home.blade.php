            ...
            <div class="nav-right col">
                <ul class="nav-menus">
                    ...
                    <li class="onhover-dropdown">
                        <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle blur-up lazyloaded" src="{{ asset('uploads') }}/profile_pic/{{ Auth::guard('web')->user()->profile_pic }}" alt="header-user">
        ...
        <div class="page-sidebar">
            ...
            <div class="sidebar custom-scrollbar">
                <div class="sidebar-user text-center">
                    ...
                    <h6 class="mt-3 f-14">Welcome, {{ Auth::guard('web')->user()->name }}</h6>
                    <p>general manager.</p>
                </div>
                    ...
                    <li><a class="sidebar-header" href=""><i data-feather="box"></i> <span>Products</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li>
                                ...
                                <ul class="sidebar-submenu">
                                    <li><a href="" class="active"><i class="fa fa-circle"></i>Category</a></li>
                                    <li><a href=""><i class="fa fa-circle"></i>Sub Category</a></li>
                                    <li><a href="" ><i class="fa fa-circle"></i>Product List</a></li>
                                    <li><a href=""><i class="fa fa-circle"></i>Add Product</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="" fa fa-circle></i>
...
<li><a class="sidebar-header" href="invoice.show"><i data-feather="archive"></i><span>Invoice</span></a>
                    </li>
                                    ...
                                    <table class="table table-bordernone mb-0">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('admin_assets') }}/images/dashboard/user2.jpg" alt="" data-original-title="" title="">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('admin_assets') }}/images/dashboard/user1.jpg" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('admin_assets') }}/images/dashboard/man.png" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('admin_assets') }}/images/dashboard/user.png" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('admin_assets') }}/images/dashboard/designer.jpg" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
