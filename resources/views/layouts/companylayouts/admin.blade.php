...
<head>
    ...
    <scrip src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"><scrip>
    <scrip src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.bundle.min.js"><scrip>
            ...
            <div class="nav-right col">
                <ul class="nav-menus">
                    ...
                    <li class="onhover-dropdown">
                        <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle blur-up lazyloaded" src="{{ asset('uploads') }}/company_logo/{{ Auth::user()->logo }}" alt="header-user">
                        ...
                        <ul class="profile-dropdown onhover-show-div p-20">
                            ...
                            <li><a href="{{ route('admin.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i data-feather="log-out"></i>Logout</a>
                                <form action="{{ route('Company.logout') }}" id="logout-form" method="post">@csrf</form></li>
                        </ul>
                    </li>
                </ul>
        ...
        <div class="page-sidebar">
            ...
            <div class="sidebar custom-scrollbar">
                <div class="sidebar-user text-center">
                    <div><img class="img-60 rounded-circle blur-up lazyloaded" src="{{ asset('uploads') }}/company_logo/{{ Auth::user()->logo }}" alt="#">
                    </div>
                    <h6 class="mt-3 f-14">Welcome, {{ Auth::guard('Company')->user()->title }}</h6>
                    <p>general manager.</p>
                </div>
                <ul class="sidebar-menu">
                    ...
                    <li><a class="sidebar-header" href="#"><i data-feather="align-left"></i><span>Menus</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="#"><i class="fa fa-circle"></i>Menu Lists</a></li>
                            <li><a href="#"><i class="fa fa-circle"></i>Create Menu</a></li>
                        </ul>
                    </li>
                    <li><a class="sidebar-header" href="{{ route('Company.employee.add') }}"><i data-feather="user-plus"></i><span>Employee</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('Company.employee.show') }}"><i class="fa fa-circle"></i>Employee List</a></li>
                            <li><a href="{{ route('Company.employee.add') }}"><i class="fa fa-circle"></i>Create Employee</a></li>
                        </ul>
                    </li>
                    <li><a class="sidebar-header" href=""><i data-feather="users"></i><span>Vendors</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href=""><i class="fa fa-circle"></i>Vendor List</a></li>
                            <li><a href=""><i class="fa fa-circle"></i>Create Vendor</a></li>
                        </ul>
                    </li>
                        <ul class="sidebar-submenu">
                    ...
                    <li><a class="sidebar-header" href="{{ route('Company.contact') }}"><i data-feather="bar-chart"></i><span>Contact with Admin</span></a></li>
