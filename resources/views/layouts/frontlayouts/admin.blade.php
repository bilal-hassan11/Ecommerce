...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/game.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 19:45:16 GMT -->
<head>
    ...
    <!-- Themify icon -->
    <link rel="stylesheet" type="text/css" href="{{asset('front_assets')}}/css/themify-icons.css">

    <!-- Bootstrap css -->
    <link rel="stylesheet" type="text/css" href="{{asset('front_assets')}}/css/bootstrap.css">

    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="{{asset('front_assets')}}/css/color1.css" media="screen" id="color">
...
<body>
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                ...
                                <div class="brand-logo">
                                    <a href="index.html"><img src="{{asset('front_assets')}}/images/icon/logo.png"
                                    ...
                                    <div class="icon-nav d-none d-sm-block">
                                        <ul>
                                            <li class="onhover-div mobile-search">
                                                <div><img class="img-fluid blur-up lazyload" src="{{asset('front_assets')}}/images/icon/search.png" onclick="openSearch()" alt=""> <i class="ti-search" onclick="openSearch()"></i>
                                                </div>
                                            </li>
                                            <li class="onhover-div mobile-setting">
                                                <div><img class="img-fluid blur-up lazyload" src="{{asset('front_assets')}}/images/icon/setting.png" alt=""> <i class="ti-settings"></i></div>
                                            </li>
                                            <li class="onhover-div mobile-cart">
                                                <div><img class="img-fluid blur-up lazyload" src="{{asset('front_assets')}}/images/icon/cart.png" alt=""> <i class="ti-shopping-cart"></i></div>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <ul class="header-dropdown">
                            ...
                            <li class="onhover-dropdown mobile-account">
                                ...
                                <ul class="onhover-show-div">
                                    <li><a href="{{ route('front.login') }}" data-lng="en">Login</a></li>
                                    <li><a href="{{ route('front.logout') }}" data-lng="es">Logout</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-sm-12">
                    <div class="main-menu">
                        <div class="menu-left">
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-xl-4"><a href="#"
                                                                    class="mega-menu-banner"><img
                                                                        src="{{asset('front_assets')}}/images/mega-menu/fashion.jpg"
                            ...
                            <div class="brand-logo"><a href="index.html"><img src="{{asset('front_assets')}}/images/icon/logo.png"
                        ...
                        <div class="menu-right pull-right">
                            ...
                            <div>
                                <div class="icon-nav">
                                    <ul>
                                        <li class="onhover-div mobile-search">
                                            <div><img src="{{asset('front_assets')}}/images/icon/search.png" onclick="openSearch()"
                                        ...
                                        <li class="onhover-div mobile-setting">
                                            <div><img src="{{asset('front_assets')}}/images/icon/setting.png"
                                        ...
                                        <li class="onhover-div mobile-cart">
                                            <div><img src="{{asset('front_assets')}}/images/icon/cart.png"
                                                    class="img-fluid blur-up lazyload" alt=""> <i
                                            ...
                                            <ul class="show-div shopping-cart">
                                                <li>
                                                    <div class="media">
                                                        <a href="#"><img class="mr-3"
                                                                src="{{asset('front_assets')}}/images/fashion/product/1.jpg"
                                                ...
                                                <li>
                                                    <div class="media">
                                                        <a href="#"><img class="mr-3"
                                                                src="{{asset('front_assets')}}/images/fashion/product/2.jpg"
                                                                alt="Generic placeholder image"></a>
                                                        <div class="media-body">
                                                            <a href="#">
                                                                <h4>item name</h4>
        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home text-center p-center">
                    <img src="{{asset('front_assets')}}/images/home-banner/41.jpg" alt="" class="bg-img blur-up lazyload">
                </div>
            </div>
            <div>
                <div class="home text-center p-center">
                    <img src="{{asset('front_assets')}}/images/home-banner/42.jpg" alt="" class="bg-img blur-up lazyload">
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="bg-img-gym overlay-cls effect-cls footer-effect">
        <img src="{{asset('front_assets')}}/images/parallax/27.jpg" alt="" class="bg-img blur-up lazyload">
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="footer-contant">
                                <div class="footer-logo">
                                    <img src="{{asset('front_assets')}}/images/icon/footerlogo.png" alt="">
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="payment-card-bottom">
                            <ul>
                                <li>
                                    <a href="#"><img src="{{asset('front_assets')}}/images/icon/visa.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset('front_assets')}}/images/icon/mastercard.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset('front_assets')}}/images/icon/paypal.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset('front_assets')}}/images/icon/american-express.png" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{asset('front_assets')}}/images/icon/discover.png" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <div class="modal-bg">
                                    ...
                                    <div class="offer-content">
                                        <img src="{{asset('front_assets')}}/images/Offer-banner.png" class="img-fluid blur-up lazyload"
                                            alt="">
                                        <h2>newsletter</h2>
                                        <form>
                                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-lg-6  col-xs-12">
                            <div class="quick-view-img">
                                <img src="{{asset('front_assets')}}/images/pro3/1.jpg" alt="" class="img-fluid blur-up lazyload">
                            </div>
                        </div>
            ...
            <div class="setting-body">
                ...
                <div class="buy_btn">
                    ...
                    <a href="https://themeforest.net/item/multikart-responsive-angular-ecommerce-template/22905358?s_rank=3"
                        target="_blank" class="btn btn-block purchase_btn"><img src="{{asset('front_assets')}}/images/icon/angular.png"
                    ...
                    <a href="https://themeforest.net/item/multikart-responsive-react-ecommerce-template/23067773?s_rank=2"
                        target="_blank" class="btn btn-block purchase_btn"><img src="{{asset('front_assets')}}/images/icon/react.png"
                    ...
                    <a href="https://themeforest.net/item/multikart-multipurpose-shopify-sections-theme/23093831?s_rank=1"
                        target="_blank" class="btn btn-block purchase_btn"><img src="{{asset('front_assets')}}/images/icon/shopify.png"
                                    ...
                                    <div class="media">
                                        <a href="#">
                                            <img class="img-fluid blur-up lazyload pro-img"
                                                src="{{asset('front_assets')}}/images/fashion/product/43.jpg" alt="">
                                        </a>
                                        <div class="media-body align-self-center text-center">
                                            ...
                                            <div class="upsell_payment">
                                                <img src="{{asset('front_assets')}}/images/payment_cart.png"
                                        ...
                                        <div class="row" id="upsell_product">
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                            <img src="{{asset('front_assets')}}/images/fashion/product/1.jpg"
                                            ...
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                            <img src="{{asset('front_assets')}}/images/fashion/product/34.jpg"
                                                                class="img-fluid blur-up lazyload mb-1"
                                                                alt="cotton top">
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                            <img src="{{asset('front_assets')}}/images/fashion/product/13.jpg"
                                                                class="img-fluid blur-up lazyload mb-1"
                                                                alt="cotton top">
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                            <img src="{{asset('front_assets')}}/images/fashion/product/19.jpg"
                                                                class="img-fluid blur-up lazyload mb-1"
                                                                alt="cotton top">
                                                        </a>
                                                    </div>
    ...
    <!-- menu js-->
    <script src="{{asset('front_assets')}}/js/menu.js"></script>

    <!-- lazyload js-->
    <script src="{{asset('front_assets')}}/js/lazysizes.min.js"></script>

    <!-- Bootstrap js-->
    <script src="{{asset('front_assets')}}/js/bootstrap.js"></script>

    <!-- Bootstrap Notification js-->
    <script src="{{asset('front_assets')}}/js/bootstrap-notify.min.js"></script>

    <!-- Fly cart js-->
    <script src="{{asset('front_assets')}}/js/fly-cart.js"></script>

    <!-- Timer js-->
    <script src="{{asset('front_assets')}}/js/timer.js"></script>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/game.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 19:46:42 GMT -->
</html>