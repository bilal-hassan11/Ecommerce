...
@section('content')
                            ...
                            <div id="tab-1" class="tab-content active default">
                                <div class="product-4 product-m no-arrow">
                                        ...
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html">
                                                    <img alt="" src="{{asset('front_assets')}}/images/bags/7.jpg" class="img-fluid blur-up lazyload bg-img">
                                                </a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html">
                                                    <img alt="" src="{{asset('front_assets')}}/images/bags/9.jpg" class="img-fluid blur-up lazyload bg-img">
                                                </a>
                                            </div>
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt="" src="{{asset('front_assets')}}/images/bags/19.jpg" class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img alt="" src="{{asset('front_assets')}}/images/bags/20.jpg" class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail">
                                                <a href="javascript:void(0)" title="Add to Wishlist">
                                                    <i class="ti-heart" aria-hidden="true"></i>
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt="" src="{{asset('front_assets')}}/images/bags/23.jpg" class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img alt="" src="{{asset('front_assets')}}/images/bags/24.jpg" class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail">
                                                <a href="javascript:void(0)" title="Add to Wishlist">
                                                    <i class="ti-heart" aria-hidden="true"></i>
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="lable-block"><span class="lable3">new</span></div>
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt="" src="{{asset('front_assets')}}/images/bags/1.jpg" class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img alt="" src="{{asset('front_assets')}}/images/bags/6.jpg" class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail">
                                                <a href="javascript:void(0)" title="Add to Wishlist">
                                                    <i class="ti-heart" aria-hidden="true"></i>
                                ...
                                <div class="product-4 product-m no-arrow">
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="lable-block"><span class="lable3">new</span></div>
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt="" src="{{asset('front_assets')}}/images/bags/7.jpg" class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img alt="" src="{{asset('front_assets')}}/images/bags/9.jpg" class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail">
                                                <a href="javascript:void(0)" title="Add to Wishlist">
                                                    <i class="ti-heart" aria-hidden="true"></i>
    ...
    <section class="p-0">
        <div class="full-banner banner-layout-3 parallax text-center p-center">
            <img src="{{asset('front_assets')}}/images/parallax/2.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                ...
                <div class="col-lg-4">
                    <div class="theme-card card-border">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt="" class="img-fluid blur-up lazyload" src="{{asset('front_assets')}}/images/bags/1.jpg"></a>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt="" class="img-fluid blur-up lazyload" src="{{asset('front_assets')}}/images/bags/6.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        <a href="product-page(no-sidebar).html">
                                            <h6>Slim Fit Cotton Shirt</h6>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt="" class="img-fluid blur-up lazyload" src="{{asset('front_assets')}}/images/bags/7.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        <a href="product-page(no-sidebar).html">
                                            <h6>Slim Fit Cotton Shirt</h6>
                        ...
                        <div class="offer-slider slide-1">
                            ...
                            <div>
                                <div class="product-box product-wrap">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img alt="" src="{{asset('front_assets')}}/images/bags/7.jpg" class="img-fluid blur-up lazyload"></a>
                                        </div>
                                        <div class="back">
                                            <a href="product-page(no-sidebar).html"><img alt="" src="{{asset('front_assets')}}/images/bags/9.jpg" class="img-fluid blur-up lazyload"></a>
                                        </div>
                                        <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                                    class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i
                                                    class="ti-search" aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a></div>
            ...
            <div class="row order-section">
                <div class="col-sm-4 p-0">
                    <a href="#" class="image-block">
                        <img alt="" src="{{asset('front_assets')}}/images/cat1.jpg" class="img-fluid blur-up lazyload bg-img">
                    </a>
                </div>
                <div class="col-sm-4 p-0">
                ...
                <div class="col-sm-4 p-0">
                    <a href="#" class="image-block"><img alt="" src="{{asset('front_assets')}}/images/cat2.jpg" class="img-fluid blur-up lazyload bg-img"></a>
                </div>
                <div class="col-sm-4 p-0">
                ...
                <div class="col-sm-4 p-0">
                    <a href="#" class="image-block even"><img alt="" src="{{asset('front_assets')}}/images/cat3.jpg" class="img-fluid blur-up lazyload bg-img"></a>
                </div>
                <div class="col-sm-4 p-0">
                    <div class="contain-block">
                        <div>
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="{{asset('front_assets')}}/images/blog/layout3/1.jpg" class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="{{asset('front_assets')}}/images/blog/layout3/2.jpg" class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="{{asset('front_assets')}}/images/blog/layout3/3.jpg" class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="{{asset('front_assets')}}/images/blog/layout3/4.jpg" class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="{{asset('front_assets')}}/images/blog/layout3/5.jpg" class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
            ...
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <div class="slide-7 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="{{asset('front_assets')}}/images/slider/bags/1.jpg" class="bg-img" style="width:100%">
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="{{asset('front_assets')}}/images/slider/bags/2.jpg" class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="{{asset('front_assets')}}/images/slider/bags/3.jpg" class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="{{asset('front_assets')}}/images/slider/bags/4.jpg" class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="{{asset('front_assets')}}/images/slider/bags/5.jpg" class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="{{asset('front_assets')}}/images/slider/bags/6.jpg" class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="{{asset('front_assets')}}/images/slider/bags/7.jpg" class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="{{asset('front_assets')}}/images/slider/bags/8.jpg" class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
