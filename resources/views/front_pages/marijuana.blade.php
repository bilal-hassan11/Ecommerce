...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/marijuana.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 19:48:57 GMT -->
<head>
    ...
    <link rel="icon" href="../assets/images/favicon/14.png" type="image/x-icon" />
    <link rel="shortcut icon" href="../assets/images/favicon/14.png" type="image/x-icon" />
...
<body>
    ...
    <div class="loader_skeleton">
                    ...
                    <div class="col-sm-12">
                        <div class="main-menu border-section border-top-0">
                            ...
                            <div class="brand-logo layout2-logo">
                                <a href="#"><img src="../assets/images/icon/logo/15.png"
        ...
        <section class="p-0 service_slide">
            ...
            <div class="service-home">
                <div class="container">
                    <section class="service small-section pb-0">
                        <div class="row partition4 ">
                            <div class="col-lg-2 offset-lg-2 col-6 service-block1">
                                <svg></svg>
                                <h4></h4>
                                <p></p>
                            </div>
                            <div class="col-lg-2 col-6 service-block1">
                                <svg></svg>
                                <h4></h4>
                                <p></p>
                            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="main-menu border-section border-top-0">
                        ...
                        <div class="brand-logo layout2-logo">
                            <a href="#"><img src="../assets/images/icon/logo/15.png" class="img-fluid blur-up lazyload"
                                    alt=""></a>
                        </div>
                        <div class="menu-right pull-right">
                            <div class="icon-nav">
                                <ul>
                                    ...
                                    <li class="onhover-div mobile-cart">
                                        ...
                                        <ul class="show-div shopping-cart">
                                            ...
                                            <li>
                                                <div class="media">
                                                    <a href="#"><img class="mr-3" src="../assets/images/pro/2.jpg"
                                                            alt="Generic placeholder image"></a>
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h4>item name</h4>
        ...
        <div class="slide-1 home-slider text-white">
            <div>
                <div class="home text-center p-center">
                    <img src="../assets/images/home-banner/51.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                                    <div>
                                        <h4>special offer</h4>
                                        <h1>Buy Marijuana</h1>
                                        <a href="#" class="btn btn-solid btn-gradient">shop now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div>
                <div class="home text-center p-center">
                    <img src="../assets/images/home-banner/52.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
            ...
            <div class="container">
                <section class="service small-section pb-0">
                    <div class="row partition4 ">
                        ...
                        <div class="col-lg-2 col-6 service-block1">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 60.062 60.062"
                                style="enable-background:new 0 0 60.062 60.062;" xml:space="preserve">
	...
	l-2.333-1.517l30.154-22.172L44.559,47.504z" />
                            ...
                            <p>fast and qualitative product</p>
                        </div>
                    </div>
                </section>
            </div>
    ...
    <section class="p-t-0 section-b-space ratio_45">
        <div class="container">
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-left text-center">
                            <div class="img-part">
                                <img src="../assets/images/marijuana/banner/4.jpg"
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="../assets/images/marijuana/banner/2.jpg"
                                    class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
    ...
    <!-- section start -->
    <section class="section-b-space detail-cannabis bg-grey">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="detail_section">
                        <div>
                            <svg viewBox="-29 0 396 396.05387" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <h4>19+ Only</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem blanditiis cupiditate
                                deleniti</p>
                        </div>
                    </div>
                </div>
    ...
    <!-- Product slider -->
    <div class="title3 section-t-space">
        <h4>special offer</h4>
        <h2 class="title-inner3">new products</h2>
        <div class="line"></div>
    </div>
    <section class="p-t-0 section-b-space tools-grey border-box ratio_square">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="product-5 product-m no-arrow">
                            ...
                            <div class="img-wrapper">
                                ...
                                <div class="cart-info cart-wrap">
                                    ...
                                    <a href="compare.html" title="Compare"><i class="fa fa-refresh"
                                            aria-hidden="true"></i></a>
                                    <a class="mobile-quick-view" href="#" data-toggle="modal" data-target="#quick-view"
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            src="../assets/images/marijuana/pro/1.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <a href="javascript:void(0)" title="Add to Wishlist"><i class="fa fa-heart"
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                ...
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            src="../assets/images/marijuana/pro/10.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <a href="javascript:void(0)" title="Add to Wishlist"><i class="fa fa-heart"
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            src="../assets/images/marijuana/pro/23.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <a href="javascript:void(0)" title="Add to Wishlist"><i class="fa fa-heart"
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                ...
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            src="../assets/images/marijuana/pro/19.jpg"
                                            class="img-fluid blur-up lazyload bg-img"></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <a href="javascript:void(0)" title="Add to Wishlist"><i class="fa fa-heart"
    ...
    <!-- parallax product section start -->
    <section class="full-banner parallax tools-parallax-product tab-left ratio_square  tools-grey border-box">
        <img src="../assets/images/parallax/23.jpg" alt="" class="bg-img blur-up lazyload">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="theme-tab">
                        <div class="left-side">
                            ...
                            <ul class="tabs tab-title">
                                <li class="current">
                                    <a href="tab-1.html">Cannabis Oils</a>
                                </li>
                                <li class="">
                                    <a href="tab-2.html">pre rolls</a>
                                </li>
                                <li class="">
                                    <a href="tab-3.html">marijuana edibles</a>
                                </li>
                                <li class="">
                                    <a href="tab-4.html">marijuana weeds</a>
                                </li>
                                <li class="">
                                    <a href="tab-5.html">CBD oils</a>
                                </li>
                                <li class="">
                                    <a href="tab-6.html">marijuana seeds</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="product-3 product-m no-arrow">
                                        ...
                                        <div class="img-wrapper">
                                            ...
                                            <div class="cart-info cart-wrap">
                                                ...
                                                <button data-toggle="modal" data-target="#addtocart"
                                                    title="Add to cart"><i class="ti-shopping-cart"></i> Add to
                                                    cart</button>
                                                <a href="compare.html" title="Compare"><i class="fa fa-refresh"
                                                        aria-hidden="true"></i></a>
                                                <a class="mobile-quick-view" href="#" data-toggle="modal"
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/2.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/3.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/4.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                ...
                                <div class="product-3 product-m no-arrow">
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/5.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/6.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/7.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/8.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                ...
                                <div class="product-3 product-m no-arrow">
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/9.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/11.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/12.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                ...
                                <div class="product-3 product-m no-arrow">
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/13.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/14.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/15.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/16.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                ...
                                <div class="product-3 product-m no-arrow">
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/17.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/18.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                ...
                                <div class="product-3 product-m no-arrow">
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/22.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/marijuana/pro/24.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
    ...
    <div class="container section-t-space">
        <div class="row">
            <div class="col">
                <div class="title3">
                    <h4>Recent Story</h4>
                    <h2 class="title-inner3">from the blog</h2>
                    <div class="line"></div>
                </div>
            </div>
        </div>
    </div>
    <section class="blog pt-0 section-b-space ratio3_2">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="basic-effect">
                                    <div>
                                        <img src="../assets/images/marijuana/blog/1.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="basic-effect">
                                    <div>
                                        <img src="../assets/images/marijuana/blog/2.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="basic-effect">
                                    <div>
                                        <img src="../assets/images/marijuana/blog/3.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="footer-contant">
                                <div class="footer-logo">
                                    <img src="../assets/images/icon/logo/f2.png" alt="">
                                </div>
    ...
    <div class="modal fade bd-example-modal-md theme-modal" id="ageModal" tabindex="-1" role="dialog"
                            ...
                            <div class="col-12">
                                <div class="modal-bg">
                                    ...
                                    <div class="age-content">
                                        ...
                                        <h4>This Website requires you to be 19 years or older to enter. Please enter
                                            your Date Of Birth in this fields below in order to continue:</h4>
                                        <form id="demoForm">
                                            <div>
                                                <input type="text" name="birthDay" id="birthDay" value=""
                                                    class="form-control" placeholder="DD" min="1" max="31">
                                                <input type="text" name="birthMonth" id="birthMonth" value=""
                                                    class="form-control" placeholder="MM" min="1" max="12">
                                                <input type="text" name="birthYear" id="birthYear" value=""
                                                    class="form-control" placeholder="YY">
                                            </div>
                                            <button type="submit" class="btn btn-solid btn-gradient">submit</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-bg addtocart">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body align-self-center text-center">
                                            ...
                                            <div class="buttons">
                                                <a href="#" class="view-cart btn-gradient btn btn-solid">Your cart</a>
                                                <a href="#" class="checkout btn-gradient btn btn-solid">Check out</a>
                                                <a href="#" class="continue btn-gradient btn btn-solid">Continue
                                                    shopping</a>
                                            </div>
        ...
        <div class="setting_box_body">
            ...
            <div class="setting-body">
                ...
                <div class="setting-contant">
                    <ul class="color-box">
                        <li>
                            <input id="ColorPicker1" type="color" value="#5d7227" name="Background">
                            <span>theme deafult color</span>
                        </li>
                        <li>
                            <input id="ColorPicker2" type="color" value="#5d7227" name="Background">
                            <span>gradient color 1</span>
                        </li>
                        <li>
                            <input id="ColorPicker3" type="color" value="#203f15" name="Background">
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/marijuana.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 19:50:21 GMT -->
</html>