...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/gym-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 19:46:43 GMT -->
<head>
    ...
    <link rel="icon" href="../assets/images/favicon/13.png" type="image/x-icon" />
    <link rel="shortcut icon" href="../assets/images/favicon/13.png" type="image/x-icon" />
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="../assets/css/color13.css" media="screen" id="color">
...
<body>
    ...
    <div class="loader_skeleton">
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="index.html"> <img src="../assets/images/gym/logo.png" class="img-fluid blur-up lazyload" alt=""></a>
                                </div>
                            </div>
        ...
        <section class="collection-banner banner-furniture large-banner banner-padding">
        ...
        <div class="container inside-detail center_details section-b-space">
    ...
    <section class="p-0 gym-slider">
        <div class="slide-1 home-slider">
            <div>
                <div class="home text-right p-right">
                    <img src="../assets/images/home-banner/43.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                                    <div>
                                        ...
                                        <a href="#" class="btn btn-solid btn-gradient">save up to 50% off</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div>
                <div class="home p-right text-right">
                    <img src="../assets/images/home-banner/44.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
            ...
            <div class="row partition2">
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-left text-left">
                            <div class="img-part">
                                <img src="../assets/images/gym/banner/1.jpg" class="img-fluid blur-up lazyload" alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                                    <h4>save 30%</h4>
                ...
                <div class="col-md-8">
                    <a href="#">
                        <div class="collection-banner p-left text-left">
                            <div class="img-part">
                                <img src="../assets/images/gym/banner/2.jpg" class="img-fluid blur-up lazyload" alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                                    <h4>save 30%</h4>
            ...
            <div class="row partition-cls">
                ...
                <div class="col-xl-3 col-6">
                    <div class="product-box ">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="../assets/images/gym/pro/5.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                                        class="ti-shopping-cart"></i></button>
                ...
                <div class="col-xl-3 col-6">
                    <div class="product-box ">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="../assets/images/gym/pro/6.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                                        class="ti-shopping-cart"></i></button>
                ...
                <div class="col-xl-3 col-6">
                    <div class="product-box ">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="../assets/images/gym/pro/7.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                                        class="ti-shopping-cart"></i></button>
                ...
                <div class="col-xl-3 col-6">
                    <div class="product-box ">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="../assets/images/gym/pro/8.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                                        class="ti-shopping-cart"></i></button>
    ...
    <div class="full-banner gym-parallax parallax p-0 ratio_square">
        <img src="../assets/images/parallax/25.jpg" alt="" class="bg-img">
                ...
                <div class="row part-cls">
                    <div class="col-xl-3 col-6">
                        <div class="product-box ">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="../assets/images/gym/pro/9.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                                            class="ti-shopping-cart"></i></button>
                    ...
                    <div class="col-xl-3 col-6">
                        <div class="product-box ">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="../assets/images/gym/pro/13.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                                            class="ti-shopping-cart"></i></button>
                    ...
                    <div class="col-xl-3 col-6">
                        <div class="product-box ">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="../assets/images/gym/pro/11.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                                            class="ti-shopping-cart"></i></button>
                    ...
                    <div class="col-xl-3 col-6">
                        <div class="product-box ">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="../assets/images/gym/pro/12.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                                            class="ti-shopping-cart"></i></button>
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="basic-effect">
                                    <div>
                                        <img src="../assets/images/gym/blog/1.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="basic-effect">
                                    <div>
                                        <img src="../assets/images/gym/blog/2.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="basic-effect">
                                    <div>
                                        <img src="../assets/images/gym/blog/3.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="basic-effect">
                                    <div>
                                        <img src="../assets/images/gym/blog/4.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="basic-effect">
                                    <div>
                                        <img src="../assets/images/gym/blog/5.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
    ...
    <!-- instagram section -->
    <div class="section-t-space full-banner gym-parallax parallax p-0 ratio_square">
        <img src="../assets/images/parallax/26.jpg" alt="" class="bg-img blur-up lazyload">
        <div class="instagram section-t-space section-b-space">
            <div class="container ">
                <div class="row">
                    <div class="col-md-12 ">
                        <h2 class="title-borderless text-white"># instagram</h2>
                        <div class="slide-6 no-arrow slick-instagram">
                            <div>
                                <a href="#">
                                    <div class="instagram-box">
                                        <img src="../assets/images/slider/gym/1.jpg" class="bg-img" alt="Avatar" style="width:100%">
                                        <div class="overlay">
                            ...
                            <div>
                                <a href="#">
                                    <div class="instagram-box">
                                        <img src="../assets/images/slider/gym/2.jpg" class="bg-img" alt="Avatar" style="width:100%">
                                        <div class="overlay">
                                            <i class="fa fa-instagram" aria-hidden="true"></i>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <a href="#">
                                    <div class="instagram-box">
                                        <img src="../assets/images/slider/gym/3.jpg" class="bg-img" alt="Avatar" style="width:100%">
                                        <div class="overlay">
                                            <i class="fa fa-instagram" aria-hidden="true"></i>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <a href="#">
                                    <div class="instagram-box">
                                        <img src="../assets/images/slider/gym/4.jpg" class="bg-img" alt="Avatar" style="width:100%">
                                        <div class="overlay">
                                            <i class="fa fa-instagram" aria-hidden="true"></i>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <a href="#">
                                    <div class="instagram-box">
                                        <img src="../assets/images/slider/gym/5.jpg" class="bg-img" alt="Avatar" style="width:100%">
                                        <div class="overlay">
                                            <i class="fa fa-instagram" aria-hidden="true"></i>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <a href="#">
                                    <div class="instagram-box">
                                        <img src="../assets/images/slider/gym/7.jpg" class="bg-img" alt="Avatar" style="width:100%">
                                        <div class="overlay">
                                            <i class="fa fa-instagram" aria-hidden="true"></i>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <a href="#">
                                    <div class="instagram-box">
                                        <img src="../assets/images/slider/gym/6.jpg" class="bg-img" alt="Avatar" style="width:100%">
                                        <div class="overlay">
                                            <i class="fa fa-instagram" aria-hidden="true"></i>
                                        </div>
                                    </div>
                                    ...
                                    <div class="offer-content"> <img src="../assets/images/Offer-banner.png" class="img-fluid blur-up lazyload" alt="">
                                        ...
                                        <form action="https://pixelstrap.us19.list-manage.com/subscribe/post?u=5a128856334b598b395f1fc9b&amp;id=082f74cbda" class="auth-form needs-validation" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank">
                                            <div class="form-group mx-sm-3">
                                                ...
                                                <button type="submit" class="btn btn-gradient btn-solid" id="mc-submit">subscribe</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
        ...
        <div class="setting_box_body">
            ...
            <div class="setting-body">
                ...
                <div class="setting-contant">
                    <ul class="color-box">
                        <li>
                            <input id="ColorPicker1" type="color" value="#01effc" name="Background">
                            <span>theme deafult color</span>
                        </li>
                        <li>
                            <input id="ColorPicker2" type="color" value="#01effc" name="Background">
                            <span>gradient color 1</span>
                        </li>
                        <li>
                            <input id="ColorPicker3" type="color" value="#485ff2" name="Background">
                                ...
                                <div class="modal-bg addtocart">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body align-self-center text-center">
                                            ...
                                            <div class="buttons">
                                                <a href="#" class="view-cart btn btn-solid btn-gradient">Your cart</a>
                                                <a href="#" class="checkout btn btn-solid btn-gradient">Check out</a>
                                                <a href="#" class="continue btn btn-solid btn-gradient">Continue
                                                    shopping</a>
                                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 rtl-text">
                            <div class="product-right">
                                ...
                                <div class="product-buttons"><a href="#" class="btn btn-gradient btn-solid">add to
                                        cart</a> <a href="#" class="btn btn-gradient btn-solid">view detail</a></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.getElementById("ColorPicker2").onchange = function() {
            ...
            document.documentElement.style.setProperty('--gradient1', color_picker2);
        };
        document.getElementById("ColorPicker3").onchange = function() {
            color_picker3 = this.value;
            document.documentElement.style.setProperty('--gradient2', color_picker3);
        };
    </script>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/gym-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 19:48:57 GMT -->
</html>