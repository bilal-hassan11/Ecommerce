...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/marketplace-demo.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 19:43:35 GMT -->
<head>
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="../assets/css/color19.css" media="screen" id="color">
        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home text-left">
                    <img src="../assets/images/electronics/8.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container-fluid custom-container">
                        <div class="row">
                            <div class="col">
            ...
            <div class="row partition4">
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-right">
                            <div class="img-part">
                                <img src="../assets/images/fashion/banner/10.jpg" class="img-fluid blur-up lazyload bg-img">
                            </div>
                            <div class="contain-banner banner-4">
                                <div>
                                    <h4>save 60%</h4>
            ...
            <div class="row multiple-slider">
                    ...
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace/6.jpg" alt=""></a>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace/7.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace/8.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace/9.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                            ...
                            <div>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace/10.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace/14.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/marketplace/3.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                ...
                <div class="col-xl-8 col-lg-8 col-md-12">
                    ...
                    <div class="banner-tools">
                        <img src="../assets/images/offer-banner1.jpg" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/marketplace-demo.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 19:45:16 GMT -->
</html>