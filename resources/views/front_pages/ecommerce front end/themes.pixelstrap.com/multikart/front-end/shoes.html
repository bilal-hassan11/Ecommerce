...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/shoes.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:02:08 GMT -->
<head>
                    ...
                    <div class="col-sm-12">
                        <div class="main-menu border-section border-top-0">
                            ...
                            <div class="brand-logo layout2-logo">
                                <a href="#"><img src="../assets/images/icon/layout2/logo.png"
        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home text-center">
                    <img src="../assets/images/home-banner/3.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                                    <div>
                                        <h4>special offer</h4>
                                        <h1>men's shoes</h1><a href="#" class="btn btn-solid black-btn">shop now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div>
                <div class="home text-center">
                    <img src="../assets/images/home-banner/4.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
            ...
            <div>
                <div class="home text-center">
                    <img src="../assets/images/home-banner/5.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                ...
                <div class="col">
                    <div class="slide-6 no-arrow">
                        <div class="category-block">
                            <a href="#">
                                <div class="category-image"><img src="../assets/images/icon/cat1.png" alt=""></div>
                            </a>
                            <div class="category-details">
                                <a href="#">
                                    <h5>sport shoes</h5>
                        ...
                        <div class="category-block">
                            <a href="#">
                                <div class="category-image"><img src="../assets/images/icon/cat2.png" alt=""></div>
                            </a>
                            <div class="category-details">
                                <a href="#">
                                    <h5>casual shoes</h5>
                        ...
                        <div class="category-block">
                            <a href="#">
                                <div class="category-image"><img src="../assets/images/icon/cat3.png" alt=""></div>
                            </a>
                            <div class="category-details">
                                <a href="#">
                                    <h5>formal shoes</h5>
                        ...
                        <div class="category-block">
                            <a href="#">
                                <div class="category-image"><img src="../assets/images/icon/cat4.png" alt=""></div>
                            </a>
                            <div class="category-details">
                                <a href="#">
                                    <h5>flat</h5>
                        ...
                        <div class="category-block">
                            <a href="#">
                                <div class="category-image"><img src="../assets/images/icon/cat5.png" alt=""></div>
                            </a>
                            <div class="category-details">
                                <a href="#">
                                    <h5>heels</h5>
                        ...
                        <div class="category-block">
                            <a href="#">
                                <div class="category-image"><img src="../assets/images/icon/cat6.png" alt=""></div>
                            </a>
                            <div class="category-details">
                                <a href="#">
                                    <h5>boots</h5>
            ...
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="../assets/images/sub-banner.png" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="../assets/images/sub-banner1.png" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                ...
                <div class="col">
                    <div class="product-4 product-m no-arrow">
                        <div class="product-box">
                            <div class="img-block">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="../assets/images/pro/1.jpg"
                        ...
                        <div class="product-box">
                            <div class="img-block">
                                <div class="lable-wrapper"><span class="lable1">new</span> <span class="lable2">30%
                                        off</span></div>
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="../assets/images/pro/3-.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="../assets/images/pro/3--.jpg"
                        ...
                        <div class="product-box">
                            <div class="img-block">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="../assets/images/pro/4.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="../assets/images/pro/4-.jpg"
                        ...
                        <div class="product-box">
                            <div class="img-block">
                                <div class="lable-wrapper"><span class="lable1">new</span> <span class="lable2">30%
                                        off</span></div>
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="../assets/images/pro/5.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="../assets/images/pro/5--.jpg"
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/blog/layout2/1.jpg"
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/blog/layout2/2.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/blog/layout2/3.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/blog/layout2/4.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/blog/layout2/5.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="slide-5 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/shoes/2.jpg" class="bg-img"
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/shoes/3.jpg" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/shoes/4.jpg" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/shoes/9.jpg" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/shoes/6.jpg" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/shoes/7.jpg" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/shoes/8.jpg" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/shoes/10.jpg"
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/shoes/1.jpg" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                            ...
                            <div class="footer-block">
                                <div class="footer-container">
                                    ...
                                    <div class="footer-contant">
                                        <div class="footer-logo"><img src="../assets/images/icon/layout2/logo.png"
                                                alt=""></div>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/shoes.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:02:35 GMT -->
</html>