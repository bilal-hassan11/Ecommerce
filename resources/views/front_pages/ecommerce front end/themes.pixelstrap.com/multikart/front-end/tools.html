...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/tools.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 19:41:46 GMT -->
<head>
                    ...
                    <div class="slide-4 category-m no-arrow">
                        <div>
                            <div class="category-wrapper pt-0">
                                <div>
                                    <div>
                                        <img src="../assets/images/tools/category/1.jpg"
                        ...
                        <div>
                            <div class="category-wrapper pt-0">
                                <div>
                                    <div>
                                        <img src="../assets/images/tools/category/2.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                        ...
                        <div class="category-wrapper pt-0">
                            <div>
                                <div>
                                    <img src="../assets/images/tools/category/3.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                        ...
                        <div class="category-wrapper pt-0">
                            <div>
                                <div>
                                    <img src="../assets/images/tools/category/4.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                        ...
                        <div class="category-wrapper pt-0">
                            <div>
                                <div>
                                    <img src="../assets/images/tools/category/5.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt="">
                                </div>
                                <h4>other parts</h4>
                                <ul class="category-link">
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                ...
                                <div class="cart-info cart-wrap">
                                    <a href="javascript:void(0)" title="Add to Wishlist"><i class="fa fa-heart"
                                            aria-hidden="true"></i></a>
                                    <button onclick="openCart()" title="Add to cart"><i class="ti-shopping-cart"></i>
                                        Add to cart</button>
                                    <a href="compare.html" title="Compare"><i class="fa fa-refresh"
                                            aria-hidden="true"></i></a>
                                    <a class="mobile-quick-view" href="#" data-toggle="modal" data-target="#quick-view"
                    ...
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/tools/pro/6.jpg" alt=""></a>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/tools/pro/7.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/tools/pro/12.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/tools/pro/13.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/tools/pro/9.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/tools/pro/10.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/tools/pro/14.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/tools/pro/15.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="product_4 product-m no-arrow">
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/tools/pro/17.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/tools/pro/18.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/tools/pro/19.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                ...
                                <div class="product_4 product-m no-arrow">
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/tools/pro/20.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/tools/pro/21.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/tools/pro/22.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/tools/pro/23.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <a href="javascript:void(0)" title="Add to Wishlist"><i
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/tools.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 19:43:35 GMT -->
</html>