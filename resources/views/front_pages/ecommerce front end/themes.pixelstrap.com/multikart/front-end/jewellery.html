...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/jewellery.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 19:51:23 GMT -->
<head>
    ...
    <link rel="icon" href="../assets/images/favicon/16.png" type="image/x-icon" />
    <link rel="shortcut icon" href="../assets/images/favicon/16.png" type="image/x-icon" />
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="../assets/css/color16.css" media="screen" id="color">
...
<body class="bg_cls">
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="index.html"> <img src="../assets/images/icon/logo/13.png"
                                    ...
                                    <div class="icon-nav d-none d-sm-block">
                                        <ul>
                                            ...
                                            <li class="onhover-div mobile-setting">
                                                <div><img src="../assets/images/jewellery/icon/controls.png"
        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home text-center">
                    <img src="../assets/images/home-banner/47.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
            ...
            <div>
                <div class="home text-center bg-position p-right">
                    <img src="../assets/images/home-banner/48.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
        ...
        <section class="section-b-space border-section border-top-0">
			...
			h75.636L290.019,449.71z M366.848,266.369l30.767-73.418l41.502,73.418H366.848z" />
                        ...
                        <div class="category-block">
                            <a href="#">
                                <div class="category-image svg-image">
                                    <svg height="512pt" viewBox="-64 0 512 512.13948" width="512pt"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <div class="category-block">
                            <a href="#">
                                <div class="category-image svg-image">
                                    <svg height="512pt" viewBox="0 0 512 512.00089" width="512pt"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                    ...
                    <div class="product-4 product-m no-arrow">
                        ...
                        <div class="product-box">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="../assets/images/jewellery/pro/4.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info cart-wrap">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
    ...
    <section class="p-0">
        <div class="full-banner parallax text-center p-left">
            <img src="../assets/images/parallax/18.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                                ...
                                <div class=" no-slider row">
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/jewellery/pro/7.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/jewellery/pro/13.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart"
                                ...
                                <div class=" no-slider row">
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/jewellery/pro/17.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/jewellery/pro/18.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/jewellery/pro/19.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/jewellery/pro/20.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/jewellery/pro/21.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart"
                ...
                <div class="col-md-12">
                    ...
                    <div class="slide-5 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/slider/jewellery/1.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/slider/jewellery/2.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/slider/jewellery/4.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/slider/jewellery/5.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/slider/jewellery/6.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/slider/jewellery/9.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/slider/jewellery/8.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                                ...
                                <div class="footer-container">
                                    ...
                                    <div class="footer-contant">
                                        <div class="footer-logo">
                                            <img src="../assets/images/icon/logo/13.png" alt="">
                                        </div>
    ...
    <!-- demo modal -->
    <div class="modal fade bd-example-modal-xl theme-modal demo-modal" data-target=".bd-example-modal-xl"
        id="demo-modal" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="title-text text-center">
                                        <h3>21 <span><i class="fa fa-plus" aria-hidden="true"></i></span></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/index.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/index.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/fashion-2.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/fashion-2.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/fashion-3.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/fashion-3.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/shoes.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/shoes.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/bags.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/bags.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/watch.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/watch.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/kids.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/kids.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/flower.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/flower.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/nursery.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/nursery.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/vegetables.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/vegetables.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/beauty.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/beauty.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/instagram-shop.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/instagram-shop.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects effect-2">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/lookbook-demo.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/lookbook-demo.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/light.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/light.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/full-page.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/full-page.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/electronic-1.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/electronic-1.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/electronic-2.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/electronic-2.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects effect-2">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/video.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/video.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/goggles.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/goggles.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/parallax.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/parallax.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects">
                                    <div class="set-position">
                                        ...
                                        <div class="demo-text">
                                            ...
                                            <div class="btn-group demo-btn" role="group" aria-label="Basic example">
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/LTR/furniture.html')"
                                                    class="btn new-tab-btn">Preview</button>
                                                <button type="button"
                                                    onClick="window.open('http://themes.pixelstrap.com/multikart/RTL/furniture.html')"
                                                    class="btn new-tab-btn">RTL</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-4 col-sm-6 col-12 text-center demo-effects effect-3">
                                    <div class="set-position">
                                        <div class="layout-container demo39"></div>
                                        <div class="demo-text">
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/jewellery.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 19:52:29 GMT -->
</html>