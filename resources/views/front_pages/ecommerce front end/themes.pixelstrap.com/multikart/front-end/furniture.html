...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/furniture.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:08:13 GMT -->
<head>
...
<body>
                                                ...
                                                <ul class="mega-menu clothing-menu">
                                                    <li>
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-xl-4">
                                                                <a href="#" class="mega-menu-banner"><img src="../assets/images/mega-menu/furniture/1.jpg" alt="" class="img-fluid blur-up lazyload"></a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
                                ...
                                <ul>
                                    ...
                                    <li class="onhover-div mobile-cart">
                                        ...
                                        <ul class="show-div shopping-cart">
                                            <li>
                                                <div class="media">
                                                    <a href="#"><img class="mr-3" src="../assets/images/furniture/product/4.jpg" alt=""></a>
                                            ...
                                            <li>
                                                <div class="media">
                                                    <a href="#"><img class="mr-3" src="../assets/images/furniture/product/10.jpg" alt=""></a>
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h4>item name</h4>
                                                        </a>
    ...
    <section class="p-0">
        <div class="slide-1 home-slider">
            ...
            <div>
                <div class="home text-left">
                    <img src="../assets/images/home-banner/13.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
            ...
            <div class="row partition3">
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-right text-right">
                            <div class="img-part">
                                <img src="../assets/images/furniture/2banner1.jpg" alt="" class="img-fluid blur-up lazyload bg-img">
                            </div>
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-right text-right">
                            <div class="img-part">
                                <img src="../assets/images/furniture/2banner2.jpg" alt="" class="img-fluid blur-up lazyload bg-img">
                            </div>
                            <div class="contain-banner banner-3">
                                <div>
                                    <h4>save 60%</h4>
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-right text-right">
                            <div class="img-part">
                                <img src="../assets/images/furniture/2banner3.jpg" alt="" class="img-fluid blur-up lazyload bg-img">
                            </div>
                            <div class="contain-banner banner-3">
                                <div>
                                    <h4>save 60%</h4>
                                ...
                                <div class="no-slider row">
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img src="../assets/images/furniture/product/1.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img src="../assets/images/furniture/product/2.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i
                                                        class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img src="../assets/images/furniture/product/3.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i
                                                        class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="lable-block"><span class="lable3">new</span> <span class="lable4">on sale</span></div>
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img src="../assets/images/furniture/product/4.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info cart-wrap">
                                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i class="ti-shopping-cart"></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i
                                                        class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i
    ...
    <section class="p-0">
        <div class="full-banner parallax text-center p-left">
            <img src="../assets/images/parallax/3.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                ...
                <div class="col-md-12">
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/furniture/blog1.jpg" class="img-fluid blur-up lazyload bg-img">
                                    </div>
                                    <span></span>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div><img alt="" src="../assets/images/furniture/blog2.jpg" class="img-fluid blur-up lazyload bg-img">
                                    </div>
                                    <span></span>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/furniture/blog3.jpg" class="img-fluid blur-up lazyload bg-img">
                                    </div>
                                    <span></span>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div>
                                    <div class="classic-effect">
                                        <img alt="" src="../assets/images/furniture/blog2.jpg" class="img-fluid blur-up lazyload bg-img">
                                    </div>
                                    <span></span>
                                </div>
                            </a>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/furniture.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:08:47 GMT -->
</html>