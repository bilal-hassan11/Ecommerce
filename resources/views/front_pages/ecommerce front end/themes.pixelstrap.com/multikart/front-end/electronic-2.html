...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/electronic-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:02:59 GMT -->
<head>
    ...
    <link rel="icon" href="../assets/images/favicon/9.png" type="image/x-icon">
    <link rel="shortcut icon" href="../assets/images/favicon/9.png" type="image/x-icon">
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="../assets/css/color9.css" media="screen" id="color">
...
<body>
                        ...
                        <div class="main-menu">
                            ...
                            <div class="absolute-logo">
                                <div class="brand-logo">
                                    <a href="#"><img alt="" src="../assets/images/icon/logo/5.png"></a>
                                </div>
                            </div>
                            <div class="">
    ...
    <div class="container banner-slider">
        <div class="row">
            <div class="col-md-7"><img src="../assets/images/electronics/1.jpg"
                    class="img-fluid blur-up lazyload height-banner" alt=""></div>
            <div class="col-md-5">
                <div class="row home-banner">
                    <div class="col-12">
            ...
            <div class="row partition3">
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-right text-right">
                            <div class="img-part">
                                <img src="../assets/images/electronics/5.jpg" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="contain-banner banner-3">
                                <div>
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-right text-right">
                            <div class="img-part">
                                <img src="../assets/images/electronics/6.jpg" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="contain-banner banner-3">
                                <div>
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-right text-right">
                            <div class="img-part">
                                <img src="../assets/images/electronics/7.jpg" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="contain-banner banner-3">
                                <div>
                ...
                <div class="col">
                    <div class="theme-tab">
                        <ul class="tabs tab-title2">
                            ...
                            <li class=""><a href="tab-2.html">top sell</a></li>
                            <li class=""><a href="tab-3.html">featured</a></li>
                        </ul>
                                ...
                                <div class="row no-slider">
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/electronics/product/2.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/electronics/product/7.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/electronics/product/8.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/electronics/product/9.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img alt=""
                                                        src="../assets/images/electronics/product/10.jpg"
                                                        class="img-fluid blur-up lazyload bg-img"></a>
                                            </div>
                                            <div class="cart-detail">
                                                <button data-toggle="modal" data-target="#addtocart"
                ...
                <div class="row footer-theme partition-f">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="footer-contant">
                            <div class="footer-logo"><img src="../assets/images/icon/logo/5.png" alt=""></div>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/electronic-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:03:55 GMT -->
</html>