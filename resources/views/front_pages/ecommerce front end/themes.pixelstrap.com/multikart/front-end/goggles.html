...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/goggles.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:08:47 GMT -->
<head>
...
<body>
            ...
            <div class="slide-1 home-slider">
                <div>
                    <div class="home text-left">
                        <img src="../assets/images/home-banner/17.jpg" alt="" class="bg-img blur-up lazyload">
                        <div class="row">
                            <div class="col">
                ...
                <div>
                    <div class="home text-left">
                        <img src="../assets/images/home-banner/18.jpg" alt="" class="bg-img blur-up lazyload">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                                    <div>
    ...
    <section class="section-b-space banner-goggles ratio2_1">
        <div class="container">
            <div class="row partition3">
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-left">
                            ...
                            <img src="../assets/images/goggles/sub-banner.jpg" class="img-fluid blur-up lazyload bg-img"
                                alt="">
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-left text-left"><img
                                src="../assets/images/goggles/sub-banner2.jpg" class="img-fluid blur-up lazyload bg-img"
                                alt="">
                            <div class="contain-banner banner-3">
                                <div>
                                    <h4>10% off</h4>
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-left"><img src="../assets/images/goggles/sub-banner3.jpg"
    ...
    <section class="p-0">
        <div class="full-banner parallax text-center p-left">
            <img src="../assets/images/parallax/10.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                                ...
                                <div class="product-4 product-m no-arrow">
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/goggles/product/23.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
                                ...
                                <div class="product-4 product-m no-arrow">
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/goggles/product/21.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
                                ...
                                <div class="product-4 product-m no-arrow">
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/goggles/product/20.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="slide-5 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/goggles/2.jpg"
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/goggles/3.jpg"
                                        class="bg-img" alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/goggles/4.jpg"
                                        class="bg-img" alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/goggles/9.jpg"
                                        class="bg-img" alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/goggles/6.jpg"
                                        class="bg-img" alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/goggles/7.jpg"
                                        class="bg-img" alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="../assets/images/slider/goggles/8.jpg"
                                        class="bg-img" alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                ...
                <div class="row footer-theme partition-f">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="footer-contant">
                            <div class="footer-logo"><img src="../assets/images/icon/logo/4.png" alt=""></div>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/goggles.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:09:37 GMT -->
</html>