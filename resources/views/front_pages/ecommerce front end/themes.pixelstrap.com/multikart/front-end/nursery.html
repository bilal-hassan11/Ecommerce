...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/nursery.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:05:07 GMT -->
<head>
    ...
    <link rel="icon" href="../assets/images/favicon/11.png" type="image/x-icon">
    <link rel="shortcut icon" href="../assets/images/favicon/11.png" type="image/x-icon">
                        ...
                        <div class="main-menu row">
                                                                ...
                                                                <div class="row m-0">
                                                                    ...
                                                                    <div class="col-xl-4">
                                                                        <a href="#" class="mega-menu-banner"><img
                                                                                src="../assets/images/mega-menu/nursery/1.jpg"
                                                                                alt=""
                            ...
                            <div class="absolute-logo">
                                <div class="brand-logo">
                                    <a href="#"><img alt="" src="../assets/images/icon/logo/7.png"></a>
                                </div>
                            </div>
                            <div class="">
                                                ...
                                                <li class="onhover-div mobile-cart">
                                                    ...
                                                    <ul class="show-div shopping-cart">
                                                        <li>
                                                            <div class="media">
                                                                <a href="#"><img alt="" class="mr-3"
                                                                        src="../assets/images/nursery/pro/1.jpg"></a>
                                                        ...
                                                        <li>
                                                            <div class="media">
                                                                <a href="#"><img alt="" class="mr-3"
                                                                        src="../assets/images/nursery/pro/2.jpg"></a>
                                                                <div class="media-body"><a href="#">
                                                                        <h4>item name</h4>
                                                                    </a>
                                                                    <h4><span>1 x $ 299.00</span></h4>
                                                        ...
                                                        <li>
                                                            <div class="buttons"><a href="cart.html"
                                                                    class="view-cart">view cart</a> <a href="#"
                        ...
                        <div class="col">
                            ...
                            <div class="theme-tab">
                                <ul class="tabs tab-title">
                                    <li class="current"><a href="tab-7.html">featured</a></li>
                                    <li class=""><a href="tab-8.html">best product</a></li>
                                    <li class=""><a href="tab-9.html">sale product</a></li>
                                </ul>
                        ...
                        <div class="row footer-theme2">
                            <div class="col-lg-3">
                                ...
                                <div class="footer-contant">
                                    <div class="footer-logo"><img src="../assets/images/icon/logo/f2.png" alt=""></div>
        ...
        <div class="setting_box_body">
            ...
            <div class="setting-body">
                ...
                <div class="setting-contant">
                    <ul class="color-box">
                        <li>
                            <input id="ColorPicker1" type="color" value="#81ba00" name="Background">
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/nursery.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:05:41 GMT -->
</html>