...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/element-no_slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:12:13 GMT -->
<head>
                ...
                <div class="col-sm-6">
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">no slider</li>
                        </ol>
                    </nav>
                </div>
            </div>
