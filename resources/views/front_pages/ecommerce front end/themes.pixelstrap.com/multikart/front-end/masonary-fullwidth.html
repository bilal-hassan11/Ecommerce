...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/masonary-fullwidth.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:12:10 GMT -->
<head>
...
<body>
    ...
    <section class="portfolio-section portfolio-padding pt-0 port-col zoom-gallery fullwidth-portfolio">
        <div class="container-fluid">
            <div class="isotopeContainer row">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 isotopeSelector bags">
                    <div class="overlay">
                        <div class="border-portfolio">
                            <a href="../assets/images/portfolio/12.jpg">
                                <div class="overlay-background">
                                    <i class="fa fa-plus" aria-hidden="true"></i>
                                </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 isotopeSelector watch">
                    <div class="overlay">
                        <div class="border-portfolio">
                            <a href="../assets/images/portfolio/18.jpg">
                                <div class="overlay-background">
                                    <i class="fa fa-plus" aria-hidden="true"></i>
                                </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 isotopeSelector bag">
                    <div class="overlay">
                        <div class="border-portfolio">
                            <a href="../assets/images/portfolio/19.jpg">
                                <div class="overlay-background">
                                    <i class="fa fa-plus" aria-hidden="true"></i>
                                </div>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/masonary-fullwidth.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:12:11 GMT -->
</html>