...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/full-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:10:21 GMT -->
<head>
    ...
    <link rel="shortcut icon" href="../assets/images/favicon/6.png" type="image/x-icon">
...
<body>
                    ...
                    <div class="main-menu">
                        <div class="menu-left">
                            ...
                            <div class="brand-logo">
                                <a href="index.html"><img src="../assets/images/icon/logo/2.png"
    ...
    <div class="home-slider fullpage full-slider">
        <div>
            <div class="home text-left p-left">
                <img src="../assets/images/home-banner/25.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
                                <div>
                                    ...
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        ...
                                        href="#" class="btn btn-solid">view collection</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div>
            <div class="home text-left p-left">
                <img src="../assets/images/home-banner/24.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
        ...
        <div>
            <div class="home text-left p-left">
                <img src="../assets/images/home-banner/23.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
        ...
        <div>
            <div class="home text-left p-left">
                <img src="../assets/images/home-banner/26.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
    ...
    <!--footer section -->
    <footer class="full-scroll-footer">
        ...
        <div class="setting_box_body">
            ...
            <div class="setting-body">
                ...
                <div class="setting-contant">
                    <ul class="color-box">
                        <li>
                            <input id="ColorPicker1" type="color" value="#866e6c" name="Background">
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/full-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:10:36 GMT -->
</html>