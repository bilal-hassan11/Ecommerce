...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/element-mulitiple_slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:12:13 GMT -->
<head>
                ...
                <div class="col-sm-6">
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">multiple-slider</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt=""
                                            class="img-fluid blur-up lazyload" src="../assets/images/bags/1.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
