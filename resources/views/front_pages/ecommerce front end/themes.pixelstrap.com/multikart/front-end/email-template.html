...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/email-template.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:12:23 GMT -->
<head>
                ...
                <td>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tr>
                            <td>
                                <div class="product-box hover">
                                    <div class="product border-theme br-0">
                                        <img src="../assets/images/email-temp/pro-1.jpg" alt="product"
                                            style="width: 170px;">
                                    </div>
                            ...
                            <td>
                                <div class="product-box hover">
                                    <div class="product border-theme br-0">
                                        <img src="../assets/images/email-temp/pro-2.jpg" alt="product"
                                            style="width: 170px;" class="img-fluid blur-up lazyload">
                                    </div>
                                    <div class="product-info">
                                        <div class="rating">
                            ...
                            <td>
                                <div class="product-box hover">
                                    <div class="product border-theme br-0">
                                        <img src="../assets/images/email-temp/pro-3.jpg" alt="product"
                                            style="width: 170px;" class="img-fluid blur-up lazyload">
                                    </div>
                                    <div class="product-info">
                                        <div class="rating">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                            <tr align="center">
                                <td>
                                    <a href="#"><img src="../assets/images/email-temp/cosmetic.jpg"
                                            style="width:100%;"></a>
                                </td>
                            </tr>
                        ...
                        <tr>
                            <td style="padding: 30px;">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                    ...
                                    <tr>
                                        <td>
                                            <p style="font-size:13px; margin:0;">2018 - 19 Copy Right by Themeforest
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/email-template.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:12:43 GMT -->
</html>