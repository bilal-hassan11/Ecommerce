...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/product-page(4-image).html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:11:17 GMT -->
<head>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="row product_image_4">
                            <div class="col-6">
                                <div>
                                    <img src="../assets/images/fashion/pro/001.jpg" alt=""
                                        class="img-fluid blur-up lazyload bg-img">
                                </div>
                            </div>
                            <div class="col-6">
                                <div>
                                    <img src="../assets/images/fashion/pro/002.jpg" alt=""
                                        class="img-fluid blur-up lazyload bg-img ">
                                </div>
                            </div>
                            <div class="col-6">
                                <div>
                                    <img src="../assets/images/fashion/pro/003.jpg" alt=""
                                        class="img-fluid blur-up lazyload bg-img">
                                </div>
                            </div>
                            <div class="col-6">
                                <div>
                                    <img src="../assets/images/fashion/pro/004.jpg" alt=""
                                        class="img-fluid blur-up lazyload bg-img">
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/product-page(4-image).html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:11:44 GMT -->
</html>