...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/parallax.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:10:02 GMT -->
<head>
...
<body>
    ...
    <div class="parallax-cls">
        <section class="p-0">
            <div class="full-banner parallax-layout parallax text-center p-left">
                <img src="../assets/images/parallax/4.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
        ...
        <section class="p-0">
            <div class="full-banner parallax-layout parallax text-center p-right">
                <img src="../assets/images/parallax/5.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="banner-contain">
        ...
        <section class="p-0">
            <div class="full-banner parallax-layout parallax text-center p-left">
                <img src="../assets/images/parallax/6.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="banner-contain">
        ...
        <section class="p-0">
            <div class="full-banner parallax-layout parallax text-center p-right">
                <img src="../assets/images/parallax/7.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="banner-contain">
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/parallax.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:10:21 GMT -->
</html>