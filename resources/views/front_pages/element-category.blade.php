...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/element-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:12:12 GMT -->
<head>
    ...
    <div class="category-bg ratio_square">
        <div class="container-fluid p-0">
            <div class="row order-section">
                ...
                <div class="col-sm-4 p-0">
                    <a href="#" class="image-block"><img alt="" src="../assets/images/cat2.jpg"
                ...
                <div class="col-sm-4 p-0">
                    <a href="#" class="image-block even"><img alt="" src="../assets/images/cat3.jpg"
                            class="img-fluid blur-up lazyload bg-img"></a>
                </div>
                <div class="col-sm-4 p-0">
                    <div class="contain-block">
