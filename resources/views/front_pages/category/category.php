                    ...
                    <div class="col-sm-3 collection-filter">
                        ...
                        <div class="theme-card">
                            ...
                            <div class="offer-slider slide-1">
                                <div>
                                    <div class="media">
                                        <a href="#"><img class="img-fluid blur-up lazyload" src="<?= base_url("assets/front_assets/images/pro/1.jpg")?>" alt=""></a>
                        ...
                        <div class="collection-sidebar-banner">
                            <a href="#"><img src="<?= base_url("assets/front_assets/images/side-banner.png")?>" class="img-fluid blur-up lazyload" alt=""></a>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="top-banner-wrapper">
                                        <a href="#"><img src="<?= base_url("assets/front_assets/images/mega-menu/2.jpg")?>" class="img-fluid blur-up lazyload" alt=""></a>
                                                ...
                                                <div class="col-12">
                                                    <div class="product-filter-content">
                                                        ...
                                                        <div class="collection-grid-view">
                                                            <ul>
                                                                <li><img src="<?= base_url("assets/front_assets/images/icon/2.png")?>" alt="" class="product-2-layout-view"></li>
                                                                <li><img src="<?= base_url("assets/front_assets/images/icon/3.png")?>" alt="" class="product-3-layout-view"></li>
                                                                <li><img src="<?= base_url("assets/front_assets/images/icon/4.png")?>" alt="" class="product-4-layout-view"></li>
                                                                <li><img src="<?= base_url("assets/front_assets/images/icon/6.png")?>" alt="" class="product-6-layout-view"></li>
                                                            </ul>
                                                        </div>
                                            ...
                                            <div class="row margin-res">
                                                <div class="col-xl-3 col-6 col-grid-box">
                                                    <div class="product-box">
                                                        <div class="img-wrapper">
                                                            <div class="front">
                                                                <a href="#"><img src="<?= base_url("assets/front_assets/images/pro3/35.jpg")?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                            </div>
                                                            <div class="back">
                                                                <a href="#"><img src="<?= base_url("assets/front_assets/images/pro3/36.jpg")?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                            </div>
                                                ...
                                                <div class="col-xl-3 col-6 col-grid-box">
                                                    <div class="product-box">
                                                        <div class="img-wrapper">
                                                            <div class="front">
                                                                <a href="#"><img src="<?= base_url("assets/front_assets/images/pro3/27.jpg")?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                            </div>
                                                            <div class="back">
                                                                <a href="#"><img src="<?= base_url("assets/front_assets/images/pro3/28.jpg")?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                            </div>
                                                            <div class="cart-info cart-wrap">
                                                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                                                                        class="ti-shopping-cart"></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i
                                                ...
                                                <div class="col-xl-3 col-6 col-grid-box">
                                                    <div class="product-box">
                                                        <div class="img-wrapper">
                                                            <div class="front">
                                                                <a href="#"><img src="<?= base_url("assets/front_assets/images/pro3/1.jpg")?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                            </div>
                                                            <div class="back">
                                                                <a href="#"><img src="<?= base_url("assets/front_assets/images/pro3/2.jpg")?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                            </div>
                                                            <div class="cart-info cart-wrap">
                                                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                                                                        class="ti-shopping-cart"></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i
                                                ...
                                                <div class="col-xl-3 col-6 col-grid-box">
                                                    <div class="product-box">
                                                        <div class="img-wrapper">
                                                            <div class="front">
                                                                <a href="#"><img src="<?= base_url("assets/front_assets/images/pro3/33.jpg")?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                            </div>
                                                            <div class="back">
                                                                <a href="#"><img src="<?= base_url("assets/front_assets/images/pro3/34.jpg")?>" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                            </div>
                                                            <div class="cart-info cart-wrap">
                                                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                                                                        class="ti-shopping-cart"></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i
