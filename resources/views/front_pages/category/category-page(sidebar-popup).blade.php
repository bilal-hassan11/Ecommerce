...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/category-page(sidebar-popup).html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:10:48 GMT -->
<head>
                                                                        ...
                                                                        <div class="collection-collapse-block-content">
                                                                            <div class="collection-brand-filter">
                                                                                ...
                                                                                <div class="custom-control custom-checkbox collection-filter-checkbox">
                                                                                    ...
                                                                                    <label class="custom-control-label" for="twohundred">$100 -
                                                                                        $200</label>
                                                                                </div>
                                                                                <div class="custom-control custom-checkbox collection-filter-checkbox">
                                                                                    <input type="checkbox" class="custom-control-input" id="threehundred">
                                                                                    <label class="custom-control-label" for="threehundred">$200 -
                                                                                        $300</label>
                                                                                </div>
                                                                                <div class="custom-control custom-checkbox collection-filter-checkbox">
                                                                                    <input type="checkbox" class="custom-control-input" id="fourhundred">
                                                                                    <label class="custom-control-label" for="fourhundred">$300 -
                                                                                        $400</label>
                                                                                </div>
                                                                                <div class="custom-control custom-checkbox collection-filter-checkbox">
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/category-page(sidebar-popup).html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:10:49 GMT -->
</html>