                    ...
                    <div class="slide-4 category-m no-arrow">
                        <div>
                            <div class="category-wrapper">
                                <div>
                                    <div>
                                        <img src="{{asset('front_assets')}}/images/watch/cat1.png"
                        ...
                        <div>
                            <div class="category-wrapper">
                                <div>
                                    <div>
                                        <img src="{{asset('front_assets')}}/images/watch/cat2.png"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                        ...
                        <div class="category-wrapper">
                            <div>
                                <div>
                                    <img src="{{asset('front_assets')}}/images/watch/cat3.png" class="img-fluid blur-up lazyload bg-img"
                                        alt="">
                                </div>
                        ...
                        <div class="category-wrapper">
                            <div>
                                <div>
                                    <img src="{{asset('front_assets')}}/images/watch/cat2.png" class="img-fluid blur-up lazyload bg-img"
                                        alt="">
                                </div>
                        ...
                        <div class="category-wrapper">
                            <div>
                                <div>
                                    <img src="{{asset('front_assets')}}/images/watch/cat1.png" class="img-fluid blur-up lazyload bg-img"
                                        alt="">
                                </div>
                                <h4>watch models</h4>
                                <ul class="category-link">
                                            ...
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            ...
                                                            src="{{asset('front_assets')}}/images/pro2/7.jpg" alt=""></a>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="{{asset('front_assets')}}/images/pro2/14.jpg" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="{{asset('front_assets')}}/images/pro2/21.jpg" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="{{asset('front_assets')}}/images/pro2/33.jpg" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="{{asset('front_assets')}}/images/pro2/43.jpg" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="{{asset('front_assets')}}/images/pro2/44.jpg" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="{{asset('front_assets')}}/images/pro2/45.jpg" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="{{asset('front_assets')}}/images/pro2/51.jpg" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                ...
                <div class="col">
                    ...
                    <div class="product-4 product-m no-arrow">
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="lable-block"><span class="lable3">new</span> <span class="lable4">on
                                        sale</span></div>
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front_assets')}}/images/pro2/7.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front_assets')}}/images/pro2/6.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box">
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front_assets')}}/images/pro2/21.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front_assets')}}/images/pro2/22.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box">
                                    <button onclick="openCart()" title="Add to cart"><i
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front_assets')}}/images/pro2/33.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front_assets')}}/images/pro2/34.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box">
                                    <button onclick="openCart()" title="Add to cart"><i
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front_assets')}}/images/pro2/51.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img src="{{asset('front_assets')}}/images/pro2/50.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box">
                                    <button onclick="openCart()" title="Add to cart"><i
            ...
            <div class="row partition3">
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-left">
                            <div class="img-part">
                                <img src="{{asset('front_assets')}}/images/banner1.jpg" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-left text-left">
                            <div class="img-part">
                                <img src="{{asset('front_assets')}}/images/banner2.jpg" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-left">
                            <div class="img-part">
                                <img src="{{asset('front_assets')}}/images/banner.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                            <div class="contain-banner banner-3">
                                <div>
                                ...
                                <div>
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/pro2/7.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/pro2/6.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                            </div>
                                            <div class="cart-box">
                                                <button onclick="openCart()" title="Add to cart"><i
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('front_assets')}}/images/blog/layout4/1.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('front_assets')}}/images/blog/layout4/2.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('front_assets')}}/images/blog/layout4/3.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('front_assets')}}/images/blog/layout4/4.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('front_assets')}}/images/blog/layout4/5.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="slide-5 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/watches/1.jpg"
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/watches/2.jpg" alt="Avatar"
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/watches/3.jpg" alt="Avatar"
                                        class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/watches/4.jpg" alt="Avatar"
                                        class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/watches/5.jpg" alt="Avatar"
                                        class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/watches/6.jpg" alt="Avatar"
                                        class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/watches/7.jpg" alt="Avatar"
                                        class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/watches/8.jpg" alt="Avatar"
                                        class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
