        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home text-center">
                    <img src="{{asset('front_assets')}}/images/home-banner/30.jpg" alt="" class="bg-img">
                    <div class="container">
                        <div class="row">
                            <div class="col">
            ...
            <div>
                <div class="home text-center">
                    <img src="{{asset('front_assets')}}/images/home-banner/31.jpg" alt="" class="bg-img">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-left text-center">
                            <div class="img-part">
                                <img src="{{asset('front_assets')}}/images/flower/sub-banner2.jpg" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-8">
                    <a href="#">
                        <div class="collection-banner p-right text-right">
                            <div class="img-part">
                                <img src="{{asset('front_assets')}}/images/flower/sub-banner1.jpg" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                                ...
                                <div class="sec-1">
                                    <div class="product-box2">
                                        <div class="media">
                                            <a href="product-page(no-sidebar).html"><img
                                                    ...
                                                    src="{{asset('front_assets')}}/images/flower/product/1.jpg" alt=""></a>
                                    ...
                                    <div class="product-box2">
                                        <div class="media">
                                            <a href="product-page(no-sidebar).html"><img
                                                    class="img-fluid blur-up lazyload"
                                                    src="{{asset('front_assets')}}/images/flower/product/2.jpg" alt=""></a>
                                            <div class="media-body align-self-center">
                                                <div class="rating"><i class="fa fa-star"></i> <i
                                                        class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                        class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front text-center">
                                                <a href="#"><img src="{{asset('front_assets')}}/images/flower/product/7.jpg"
                                ...
                                <div class="sec-1">
                                    <div class="product-box2">
                                        <div class="media">
                                            <a href="product-page(no-sidebar).html"><img
                                                    class="img-fluid blur-up lazyload"
                                                    src="{{asset('front_assets')}}/images/flower/product/5.jpg" alt=""></a>
                                            <div class="media-body align-self-center">
                                                <div class="rating"><i class="fa fa-star"></i> <i
                                                        class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                        class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                    ...
                                    <div class="product-box2">
                                        <div class="media">
                                            <a href="product-page(no-sidebar).html"><img
                                                    class="img-fluid blur-up lazyload"
                                                    src="{{asset('front_assets')}}/images/flower/product/6.jpg" alt=""></a>
                                            <div class="media-body align-self-center">
                                                <div class="rating"><i class="fa fa-star"></i> <i
                                                        class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                        class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                    ...
                    <div class="col">
                        ...
                        <div class="theme-tab">
                            <ul class="tabs tab-title">
                                <li class="current"><a href="tab-7.html">winter</a></li>
                                <li class=""><a href="tab-8.html">greens</a></li>
                                <li class=""><a href="tab-9.html">various</a></li>
                            </ul>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="{{asset('front_assets')}}/images/flower/product/7.jpg" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="{{asset('front_assets')}}/images/flower/product/12.jpg" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="{{asset('front_assets')}}/images/flower/product/11.jpg" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="{{asset('front_assets')}}/images/flower/product/10.jpg" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="{{asset('front_assets')}}/images/flower/product/8.jpg" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="{{asset('front_assets')}}/images/flower/product/4.jpg" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        ...
                                        <div class="tab-box">
                                            <div class="product-box2">
                                                <div class="media">
                                                    <a href="product-page(no-sidebar).html"><img
                                                            class="img-fluid blur-up lazyload"
                                                            src="{{asset('front_assets')}}/images/flower/product/3.jpg" alt=""></a>
                                                    <div class="media-body align-self-center">
                                                        <div class="rating"><i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                                class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                    ...
                    <div class="product-4 product-m no-arrow">
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                ...
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{asset('front_assets')}}/images/flower/product/7.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{asset('front_assets')}}/images/flower/product/6.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box">
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{asset('front_assets')}}/images/flower/product/1.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{asset('front_assets')}}/images/flower/product/2.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                ...
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{asset('front_assets')}}/images/flower/product/3.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{asset('front_assets')}}/images/flower/product/4.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-box">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                        ...
                        <div class="product-box product-wrap">
                            <div class="img-wrapper">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{asset('front_assets')}}/images/flower/product/5.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page(no-sidebar).html"><img
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('front_assets')}}/images/flower/blog/1.jpg"
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('front_assets')}}/images/flower/blog/2.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="{{asset('front_assets')}}/images/flower/blog/3.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="slide-5 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="{{asset('front_assets')}}/images/flower/insta/2.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="{{asset('front_assets')}}/images/flower/insta/3.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="{{asset('front_assets')}}/images/flower/insta/4.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay">
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="{{asset('front_assets')}}/images/flower/insta/5.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="{{asset('front_assets')}}/images/flower/insta/6.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="{{asset('front_assets')}}/images/flower/insta/7.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="{{asset('front_assets')}}/images/flower/insta/8.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
