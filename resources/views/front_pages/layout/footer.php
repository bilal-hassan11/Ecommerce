   ...
   <footer class="footer-light">
                ...
                <div class="row footer-theme partition-f">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="footer-contant">
                            <div class="footer-logo"><img src="<?= base_url("assets/front_assets/images/icon/logo.png")?>" alt=""></div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="payment-card-bottom">
                            <ul>
                                <li>
                                    <a href="#"><img src="<?= base_url("assets/front_assets/images/icon/visa.png")?>" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?= base_url("assets/front_assets/images/icon/mastercard.png")?>" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?= base_url("assets/front_assets/images/icon/paypal.png")?>" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?= base_url("assets/front_assets/images/icon/american-express.png")?>" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="<?= base_url("assets/front_assets/images/icon/discover.png")?>" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="setting-body">
                ...
                <div class="buy_btn">
                    ...
                    <a href="https://themeforest.net/item/multikart-responsive-angular-ecommerce-template/22905358?s_rank=3"
                        target="_blank" class="btn btn-block purchase_btn"><img src="<?= base_url("assets/front_assets/images/icon/angular.png")?>"
                    ...
                    <a href="https://themeforest.net/item/multikart-responsive-react-ecommerce-template/23067773?s_rank=2"
                        target="_blank" class="btn btn-block purchase_btn"><img src="<?= base_url("assets/front_assets/images/icon/react.png")?>"
                    ...
                    <a href="https://themeforest.net/item/multikart-multipurpose-shopify-sections-theme/23093831?s_rank=1"
                        target="_blank" class="btn btn-block purchase_btn"><img src="<?= base_url("assets/front_assets/images/icon/shopify.png")?>"
    ...
    <!-- latest jquery-->
    <script src="<?= base_url("assets/front_assets/js/jquery-3.3.1.min.js")?>"></script>

    <!-- menu js-->
    <script src="<?= base_url("assets/front_assets/js/menu.js")?>"></script>

    <!-- lazyload js-->
    <script src="<?= base_url("assets/front_assets/js/lazysizes.min.js")?>"></script>

    <!-- popper js-->
    <script src="<?= base_url("assets/front_assets/js/popper.min.js")?>"></script>

    <!-- slick js-->
    <script src="<?= base_url("assets/front_assets/js/slick.js")?>"></script>

    <!-- Bootstrap js-->
    <script src="<?= base_url("assets/front_assets/js/bootstrap.js")?>"></script>

    <!-- Bootstrap Notification js-->
    <script src="<?= base_url("assets/front_assets/js/bootstrap-notify.min.js")?>"></script>

    <!-- Theme js-->
    <script src="<?= base_url("assets/front_assets/js/script.js")?>"></script>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:13:14 GMT -->
</html>