...
<head>
    ...
    <link rel="icon" href="<?= base_url("assets/front_assets/images/favicon/1.png")?>" type="image/x-icon">
    <link rel="shortcut icon" href="<?= base_url("assets/front_assets/images/favicon/1.png")?>" type="image/x-icon">
    ...
    <!-- Icons -->
    <link rel="stylesheet" type="text/css" href=" <?= base_url("assets/front_assets/css/fontawesome.css")?>">

    <!--Slick slider css-->
    <link rel="stylesheet" type="text/css" href="<?= base_url("assets/front_assets/css/slick.css")?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url("assets/front_assets/css/slick-theme.css")?>">

    <!-- Animate icon -->
    <link rel="stylesheet" type="text/css" href="<?= base_url("assets/front_assets/css/animate.css")?>">

    <!-- Themify icon -->
    <link rel="stylesheet" type="text/css" href="<?= base_url("assets/front_assets/css/themify-icons.css")?>">

    <!-- Bootstrap css -->
    <link rel="stylesheet" type="text/css" href="<?= base_url("assets/front_assets/css/bootstrap.css")?>">

    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="<?= base_url("assets/front_assets/css/color1.css")?>" media="screen" id="color">
                    ...
                    <div class="main-menu">
                        <div class="menu-left">
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-xl-4">
                                                                <a href="#" class="mega-menu-banner"><img
                                                                        src="<?= base_url("assets/front_assets/images/mega-menu/fashion.jpg")?>"
                            ...
                            <div class="brand-logo">
                                <a href="index.html"> <img src="<?= base_url("assets/front_assets/images/icon/logo.png")?>"
                                ...
                                <div class="icon-nav">
                                    <ul>
                                        <li class="onhover-div mobile-search">
                                            <div><img src="<?= base_url("assets/front_assets/images/icon/search.png")?>" onclick="openSearch()"
                                        ...
                                        <li class="onhover-div mobile-setting">
                                            <div><img src="<?= base_url("assets/front_assets/images/icon/setting.png")?>"
                                                    class="img-fluid blur-up lazyload" alt="">
                                        ...
                                        <li class="onhover-div mobile-cart">
                                            <div><img src="<?= base_url("assets/front_assets/images/icon/cart.png")?>"
                                                    class="img-fluid blur-up lazyload" alt="">
                                            ...
                                            <ul class="show-div shopping-cart">
                                                <li>
                                                    <div class="media">
                                                        <a href="#"><img class="mr-3"
                                                                src="<?= base_url("assets/front_assets/images/fashion/product/1.jpg")?>"
                                                ...
                                                <li>
                                                    <div class="media">
                                                        <a href="#"><img class="mr-3"
                                                                src="<?= base_url("assets/front_assets/images/fashion/product/2.jpg")?>"
                                                                alt="Generic placeholder image"></a>
                                                        <div class="media-body">
                                                            <a href="#">
                                                                <h4>item name</h4>
