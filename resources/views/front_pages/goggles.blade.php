...
@section('content')
            ...
            <div class="slide-1 home-slider">
                <div>
                    <div class="home text-left">
                        <img src="{{asset('front_assets')}}/images/home-banner/17.jpg" alt="" class="bg-img blur-up lazyload">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                                    <div>
                                        <h4>from $19.00</h4>
                                        <h1>eyeglasses</h1><a href="#" class="btn btn-solid">shop now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div>
                    <div class="home text-left">
                        <img src="{{asset('front_assets')}}/images/home-banner/18.jpg" alt="" class="bg-img blur-up lazyload">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                                    <div>
    ...
    <section class="section-b-space banner-goggles ratio2_1">
        <div class="container">
            <div class="row partition3">
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-left">
                            ...
                            <img src="{{asset('front_assets')}}/images/goggles/sub-banner.jpg" class="img-fluid blur-up lazyload bg-img"
                                alt="">
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-left text-left"><img
                                src="{{asset('front_assets')}}/images/goggles/sub-banner2.jpg" class="img-fluid blur-up lazyload bg-img"
                                alt="">
                            <div class="contain-banner banner-3">
                                <div>
                                    <h4>10% off</h4>
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-left"><img src="{{asset('front_assets')}}/images/goggles/sub-banner3.jpg"
                    ...
                    <div class="product-4 product-m no-arrow">
                            ...
                            <div class="img-block">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{asset('front_assets')}}/images/goggles/product/1.jpg"
                        ...
                        <div class="product-box">
                            <div class="img-block">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{asset('front_assets')}}/images/goggles/product/2.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                        ...
                        <div class="product-box">
                            <div class="img-block">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{asset('front_assets')}}/images/goggles/product/3.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                        ...
                        <div class="product-box">
                            <div class="img-block">
                                ...
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{asset('front_assets')}}/images/goggles/product/4.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                        ...
                        <div class="product-box">
                            <div class="img-block">
                                <div class="front">
                                    <a href="product-page(no-sidebar).html"><img
                                            src="{{asset('front_assets')}}/images/goggles/product/5.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="cart-info">
                                    <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
    ...
    <section class="p-0">
        <div class="full-banner parallax text-center p-left">
            <img src="{{asset('front_assets')}}/images/parallax/10.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
    ...
    <!-- slider tab  -->
    <section class="layout9-box ratio_asos">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="theme-tab">
                                ...
                                <div class="product-4 product-m no-arrow">
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/goggles/product/6.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/goggles/product/23.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/goggles/product/9.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/goggles/product/10.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
                                ...
                                <div class="product-4 product-m no-arrow">
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/goggles/product/11.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/goggles/product/13.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/goggles/product/14.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/goggles/product/21.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/goggles/product/15.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
                                ...
                                <div class="product-4 product-m no-arrow">
                                    <div class="product-box">
                                        <div class="img-block">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/goggles/product/16.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/goggles/product/20.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/goggles/product/17.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/goggles/product/18.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            ...
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="{{asset('front_assets')}}/images/goggles/product/19.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button data-toggle="modal" data-target="#addtocart"
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="slide-5 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/goggles/2.jpg"
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/goggles/3.jpg"
                                        class="bg-img" alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/goggles/4.jpg"
                                        class="bg-img" alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/goggles/9.jpg"
                                        class="bg-img" alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/goggles/6.jpg"
                                        class="bg-img" alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/goggles/7.jpg"
                                        class="bg-img" alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"><img src="{{asset('front_assets')}}/images/slider/goggles/8.jpg"
                                        class="bg-img" alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
