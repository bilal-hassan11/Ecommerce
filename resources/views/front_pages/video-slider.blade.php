...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/video-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 19:54:33 GMT -->
<head>
    ...
    <link rel="icon" href="../assets/images/favicon/17.png" type="image/x-icon" />
    <link rel="shortcut icon" href="../assets/images/favicon/17.png" type="image/x-icon" />
...
<body>
                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                ...
                                <div class="brand-logo">
                                    <a href="index.html"><img src="../assets/images/icon/logo/17.png"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col mega-box">
                                                            <div class="link-section">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        <li><a href="nursery.html">cart modal popup</a>
                                                                        </li>
                                ...
                                <div class=" no-slider row">
                                        ...
                                        <div class="product-detail">
                                            ...
                                            <div class="cart-bottom">
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#quick-view"
                                                    title="Quick View"><i class="fa fa-plus-circle"
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/fashion/pro/5.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/fashion/pro/06.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="product-detail">
                                    ...
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/fashion/pro/07.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                        </div>
                                        <div class="product-detail">
    ...
    <section class="p-0 advertise-section">
        <div class="full-banner parallax text-center p-center">
            <img src="../assets/images/parallax/24.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                                ...
                                <div class="">
                                    <div class="product-box2 product-box">
                                        <div class="media img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/fashion/pro/14.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/fashion/pro/014.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                            </div>
                                            <div class="media-body align-self-center">
                                                <div class="rating">
                                    ...
                                    <div class="product-box2 product-box">
                                        <div class="media img-wrapper">
                                            ...
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/fashion/pro/015.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                            </div>
                                            <div class="media-body align-self-center">
                                                <div class="rating">
                                ...
                                <div class="">
                                    <div class="product-box2 product-box">
                                        <div class="media img-wrapper">
                                            ...
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/fashion/pro/016.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                            </div>
                                            <div class="media-body align-self-center">
                                                <div class="rating">
                                    ...
                                    <div class="product-box2 product-box">
                                        <div class="media img-wrapper">
                                            <div class="front">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/fashion/pro/17.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page(no-sidebar).html"><img
                                                        src="../assets/images/fashion/pro/017.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                            </div>
                                            <div class="media-body align-self-center">
                                                <div class="rating">
    ...
    <section class="blog p-t-0 blog-left shadow-effect ratio2_3">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="slide-5 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/slider/fashion/2.jpg" alt="Avatar" class="bg-img"
                                        style="width:100%">
                                    <div class="overlay">
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/slider/fashion/3.jpg" alt="Avatar" class="bg-img"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/slider/fashion/4.jpg" alt="Avatar" class="bg-img"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/slider/fashion/9.jpg" alt="Avatar" class="bg-img"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/slider/fashion/6.jpg" alt="Avatar" class="bg-img"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/slider/fashion/7.jpg" alt="Avatar" class="bg-img"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/slider/fashion/8.jpg" alt="Avatar" class="bg-img"
                                        style="width:100%">
                                    <div class="overlay">
                                        <i class="fa fa-instagram" aria-hidden="true"></i>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="footer-contant">
                            <div class="footer-logo">
                                <img src="../assets/images/icon/logo/17.png" alt="">
                            </div>
    ...
    <div class="offer-box">
        ...
        <div class="offer-body">
            <img src="../assets/images/offer.jpg" alt="" class="img-fluid blur-up lazyload">
        </div>
    </div>
    <!-- offer section end -->
        ...
        <div class="setting_box_body">
            ...
            <div class="setting-body">
                ...
                <div class="setting-contant">
                    <ul class="color-box">
                        <li>
                            <input id="ColorPicker1" type="color" value="#e38888" name="Background">
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/video-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 19:57:33 GMT -->
</html>