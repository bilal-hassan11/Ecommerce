...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/bags.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:03:55 GMT -->
<head>
    ...
    <link rel="shortcut icon" href="../assets/images/favicon/3.png" type="image/x-icon" />
...
<body>
                        ...
                        <div class="main-menu">
                            ...
                            <div class="absolute-logo">
                                <div class="brand-logo">
                                    <a href="#"><img alt="" src="../assets/images/icon/layout3/logo.png"></a>
                                </div>
                            </div>
                            <div class="">
                                        ...
                                        <div class="icon-nav d-none d-sm-block">
                                            <ul>
                                                <li class="onhover-div mobile-search">
                                                    <div><img alt="" src="../assets/images/icon/layout4/search.png" onclick="openSearch()" class="img-fluid blur-up lazyload">
                                                        <i class="ti-search" onclick="openSearch()"></i></div>
                                                </li>
                                                <li class="onhover-div mobile-setting">
                                                    <div><img alt="" src="../assets/images/icon/layout4/setting.png" class="img-fluid blur-up lazyload"> <i class="ti-settings"></i>
                                                    </div>
                                                </li>
                                                <li class="onhover-div mobile-cart">
                                                    <div href="javascript:void(0)" onclick="openCart()"><img alt="" src="../assets/images/icon/layout4/cart.png" class="img-fluid blur-up lazyload"> <i class="ti-shopping-cart"></i></div>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="menu-right pull-right">
                                <div>
                                    <div class="icon-nav">
                                        <ul>
                                            <li class="onhover-div mobile-search">
                                                <div><img alt="" src="../assets/images/icon/layout4/search.png" onclick="openSearch()" class="img-fluid blur-up lazyload"> <i class="ti-search" onclick="openSearch()"></i></div>
        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home text-center p-center">
                    <img src="../assets/images/home-banner/6.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                                    <div>
                                        <h4>summer sale</h4>
                                        <h1>the bag</h1> <a href="#" class="btn btn-solid">save up to 50% off</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div>
                <div class="home text-center p-center">
                    <img src="../assets/images/home-banner/7.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
            ...
            <div>
                <div class="home text-center p-center">
                    <img src="../assets/images/home-banner/8.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                ...
                <div class="col">
                    <div class="theme-tab">
                        <ul class="tabs tab-title">
                            ...
                            <li class=""><a href="tab-2.html">woman</a></li>
                            <li class=""><a href="tab-3.html">man</a></li>
                            <li class=""><a href="tab-4.html">kids</a></li>
                            <li class=""><a href="tab-5.html">school-bag</a></li>
                        </ul>
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            ...
                                            <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart"
                                                        aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search"
                                                        aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a>
                                            </div>
                                        </div>
                                        <div class="product-info">
                                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
    ...
    <section class="p-0">
        <div class="full-banner banner-layout-3 parallax text-center p-center">
            <img src="../assets/images/parallax/2.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                ...
                <div class="col-lg-4">
                    <div class="theme-card card-border">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt="" class="img-fluid blur-up lazyload" src="../assets/images/bags/1.jpg"></a>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt="" class="img-fluid blur-up lazyload" src="../assets/images/bags/6.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        <a href="product-page(no-sidebar).html">
                                            <h6>Slim Fit Cotton Shirt</h6>
                                ...
                                <div class="media">
                                    <a href="product-page(no-sidebar).html"><img alt="" class="img-fluid blur-up lazyload" src="../assets/images/bags/7.jpg"></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                                        <a href="product-page(no-sidebar).html">
                                            <h6>Slim Fit Cotton Shirt</h6>
                        ...
                        <div class="offer-slider slide-1">
                            ...
                            <div>
                                <div class="product-box product-wrap">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img alt="" src="../assets/images/bags/7.jpg" class="img-fluid blur-up lazyload"></a>
                                        </div>
                                        <div class="back">
                                            <a href="product-page(no-sidebar).html"><img alt="" src="../assets/images/bags/9.jpg" class="img-fluid blur-up lazyload"></a>
                                        </div>
                                        <div class="cart-detail"><a href="javascript:void(0)" title="Add to Wishlist"><i
                                                    class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i
                                                    class="ti-search" aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a></div>
            ...
            <div class="row order-section">
                <div class="col-sm-4 p-0">
                    <a href="#" class="image-block">
                        <img alt="" src="../assets/images/cat1.jpg" class="img-fluid blur-up lazyload bg-img">
                    </a>
                </div>
                <div class="col-sm-4 p-0">
                ...
                <div class="col-sm-4 p-0">
                    <a href="#" class="image-block"><img alt="" src="../assets/images/cat2.jpg" class="img-fluid blur-up lazyload bg-img"></a>
                </div>
                <div class="col-sm-4 p-0">
                ...
                <div class="col-sm-4 p-0">
                    <a href="#" class="image-block even"><img alt="" src="../assets/images/cat3.jpg" class="img-fluid blur-up lazyload bg-img"></a>
                </div>
                <div class="col-sm-4 p-0">
                    <div class="contain-block">
                        <div>
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/blog/layout3/1.jpg" class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/blog/layout3/2.jpg" class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/blog/layout3/3.jpg" class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/blog/layout3/4.jpg" class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img alt="" src="../assets/images/blog/layout3/5.jpg" class="img-fluid blur-up lazyload bg-img">
                                        <span></span>
                                    </div>
                                </div>
                            </a>
            ...
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <div class="slide-7 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="../assets/images/slider/bags/1.jpg" class="bg-img" style="width:100%">
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="../assets/images/slider/bags/2.jpg" class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="../assets/images/slider/bags/3.jpg" class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="../assets/images/slider/bags/4.jpg" class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="../assets/images/slider/bags/5.jpg" class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="../assets/images/slider/bags/6.jpg" class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="../assets/images/slider/bags/7.jpg" class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img alt="" src="../assets/images/slider/bags/8.jpg" class="bg-img" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="row footer-theme2">
                        <div class="col-lg-3">
                            ...
                            <div class="footer-contant">
                                <div class="footer-logo"><img src="../assets/images/icon/layout3/footerlogo.png" alt="">
                                </div>
            ...
            <div class="cart_media">
                <ul class="cart_product">
                    <li>
                        <div class="media">
                            <a href="#">
                                <img alt="" class="mr-3" src="../assets/images/bags/1.jpg">
                            </a>
                    ...
                    <li>
                        <div class="media">
                            <a href="#">
                                <img alt="" class="mr-3" src="../assets/images/bags/20.jpg">
                            </a>
                            <div class="media-body">
                                <a href="#">
                                    <h4>item name</h4>
                    ...
                    <li>
                        <div class="media">
                            <a href="#"><img alt="" class="mr-3" src="../assets/images/bags/6.jpg"></a>
                            <div class="media-body">
                                <a href="#">
                                    <h4>item name</h4>
                                </a>
...
<!-- Mirrored from themes.pixelstrap.com/multikart/front-end/bags.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:05:07 GMT -->
</html>