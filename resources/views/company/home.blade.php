                        ...
                        <div class="card o-hidden widget-cards">
                            <div class="bg-warning card-body">
                                <div class="media static-top-widget row">
                                    ...
                                    <div class="media-body col-8"><span class="m-0">Employees</span>
                                        <h3 class="mb-0">$ <span class="counter">{{ count($employee) }}</span><small> This year's</small></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-bordernone mb-0">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="{{ asset('uploads') }}/profile_pic/{{ $emp->profile_pic }}" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
                                                        <h6>{{$emp->name}} <span class="text-muted digits">(250+ Online)</span></h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td style="color:#42f5e6;">{{ $emp->skills }}</td>
                                            <td>
                                            ...
                                            <td class="digits">{{ $emp->experience }}</td>
                                        </tr>
                                        @endforeach
