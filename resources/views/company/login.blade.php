...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:23:33 GMT -->
<head>
                ...
                <div class="single-item">
                    <div>
                        <div>
                            ...
                            <p>Hi! Happy To See You, We Provide Better Perfomance To Our <strong>Companies</strong> </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card tab2-card">
                <div class="card-body">
                    <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="top-profile-tab" data-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true"><i class="1f9cd" aria-hidden="true"></i>Company Login</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="top-tabContent">
                        <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                            <form class="form-horizontal auth-form" method="POST" action="{{ route('Company.check') }}">
                                @if (Session::get('fail'))
                                ...
                                <div class="form-group">
                                    <input required="" name="email" value="{{old('email')}}" type="email" class="form-control" placeholder="Username" id="email">
                                    <span class="text-danger">@error('email'){{ $message }}@enderror</span>
                                </div>
                                <div class="form-group">
                                    <input required autocomplete="current-password" name="password" type="password" class="form-control" placeholder="Password">
                                ...
                                <div class="form-button">
                                    <button class="btn btn-primary" type="submit">Login</button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                    <button class="btn btn-primary"  type="submit"><a href="{{ route('Company.register') }}"><strong>Register</strong></button></a>
                                </div> 
...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Jan 2021 20:23:38 GMT -->
</html>
