      ...
      <div class="col-xl-6">
         <div class="card">
            <div class="card-header">
               <h5>Physical Product</h5>
            </div>
            <div class="card-body">
               <form action="{{ route('admin.product.save') }}" id="configform" class="ajaxForm" enctype="multipart/form-data"  method="Post" >
                  @Csrf
                  ...
                  <input class="form-control col-xl-8 col-sm-7" name="product_type" type="hidden" value="physical" >
                           ...
                           <div class="digital-add needs-validation">
                              <div class="form-group row">
                                 ...
                                 <select id="companies"  name="product_company" style="width:58.4% !important; height: 35px; font-size:15px; margin-left:88px;" class="form-control" required >
                                    ...
                                    @empty
                                       <option value="">No Company Exist</option>
                                    @endforelse
                                 </select>
                              </div>
                              <div class="form-group row">
                                 <label for="category" style="margin-top:20px; margin-left:12px;">Parent Category:</label>
                                 <select  id="category"  name="product_category" style="width:58.4% !important; height: 35px; margin-top:-20px; font-size:15px; margin-left:170px;" class="form-control" required >
                                    <option value="">Select Parent category</option>
                                    @forelse($PhysicalCategories as $category)
                              ...
                              <div class="form-group row">
                                 <label for="sub_category" style="margin-left:12px; margin-top:20px;">Sub Category:</label>
                                 <select id="sub_category"  style="width:58% !important; font-size:15px; height: 35px; margin-top:-20px; margin-left:170px;" name="sub_category" class="form-control"></select>
                              </div>
                        </div>
                     </div> 
                     <div class="form-group mb-0">
