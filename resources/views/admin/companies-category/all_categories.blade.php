                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title f-w-600" id="exampleModalLabel">Add General</h5>
                                                    <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form  method="Post" action="{{ route('admin.company_category.save') }}" enctype="multipart/form-data">
                                                        @Csrf
                                                        <div class="form">
                                                            ...
                                                            <div class="form-group mb-0 hide">
                                                                ...
                                                                <input class="form-control" name="category_type" type="text" value="general" >
                                                            </div>
                                                        </div>
