                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <select class="form-control" required="required" name="nat">
                                    ...
                                    <option value="yes" @if(isset($update_ippool) && $update_ippool->nat == 'yes') selected @endif>YES</option>
                                    <option value="no" @if(isset($update_ippool) && $update_ippool->nat == 'no') selected @endif>NO</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-12">
...
$('#exampleModalCenter').on('show.bs.modal', function (event) {
  ...
  var modal = $(this)
  modal.find('.modal-title').text( recipient + 'IP-POOL')
